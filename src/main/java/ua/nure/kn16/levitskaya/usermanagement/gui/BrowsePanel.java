...
public class BrowsePanel extends JPanel implements ActionListener {
	...
	public User getSelectedUser() {
		...
		if (selectedRow == -1) {
			JOptionPane.showMessageDialog(this, "Please, select row of user, details of whom you want to see", "Error",
	...
	private void deleteUser(User user) {
		int result = JOptionPane.showConfirmDialog(this, MESSAGE, "Confirm deleting", JOptionPane.YES_NO_OPTION,
